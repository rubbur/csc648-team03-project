...
const MessageThread = ({ msgs, person}) => {
    ...
    const sendMessage = async () => {
        ...
        const recipientId =  msgs[0].thread_id.split('_')[0] == senderId ? msgs[0].thread_id.split('_')[1] : msgs[0].thread_id.split('_')[0];
        ...
        <div className="message-thread">
            ...
            <div className="message-box">
            {
                messageList && messageList.map((msg, index) => {
                    ...
                    const author = msg.sender_id === cookie.get("userId") ? "self" : "other";
                    return <Message key={index} timeStamp={formattedDate} author={author} text={msg.message_text} />;
                })
            }
            {
            msgs &&
            <div className="chat-box">
                <input className="chat-input" type="text" placeholder="Start Typing..." value={newMessage} onChange={e => setNewMessage(e.target.value)} />
